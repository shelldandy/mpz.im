      ...
      <nav class="nav-container">
        ...
        <div class="nav-right">
          ...
          <div class="nav-controls">
            <a href="https://github.com/shelldandy" target="_blank" rel="noopener noreferrer" aria-label="GitHub" class="nav-icon-link">
            ...
            <a href="https://linkedin.com/in/mpalau" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="nav-icon-link">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
